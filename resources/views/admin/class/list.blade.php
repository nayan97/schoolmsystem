...
<div class="col-sm-12">
    <div class="card">
        <div class="card-header">
            ...
            <div class="col-md-2">
                <a class="btn btn-primary" style="text-align: right" href="{{route('classes.create')}}">Add New</a>
            </div>
        </div>
        <div class="card-body">
                        ...
                        @foreach ($getRecord as $user )
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-warning" href="{{ route('classes.edit', $user -> id)}}"><i class="fe fe-edit"></i></a>
                                    <a class="btn btn-sm btn-danger" href="{{ route('classes.destroy', $user -> id)}}"><i class="fe fe-trash"></i></a>
                                </td>
